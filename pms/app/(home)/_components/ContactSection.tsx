...
export const ContactSection = () => {
	...
	return (
		<section className="w-full bg-[#061826] py-16">
			<div className="flex flex-col sm:flex-row gap-10 w-11/12 md:w-8/12 mx-auto px-4 py-12">
				...
				<div className="content flex-1 flex flex-col gap-2 justify-center">
					...
					<h4 className="text-2xl sm:w-2/3">
						Entre em contato e conheça mais sobre o PMS
					</h4>
					<Link
						href={whatsappLink}
						passHref>
						<Button className="mt-4 sm:mt-8 bg-[#18894C] text-white flex gap-4 text-xl font-bold rounded-3xl py-8 px-10 shadow-lg transition-transform hover:bg-[#1e9a58] hover:-translate-y-4">
							<WhatsappIcon />
